...
public class BrandManager implements BrandService {
	 ...
	 * all args yaptık
	 * 
	 * @Autowired //IOC //1 instance üretilir public BrandManager(BrandRepository
	 * brandRepository) { this.brandRepository = brandRepository; }
	 */
	...
	// brandi newliyor , alanları karrşılaştırıyor
	// rewuesti brande çevirdik
	@Override
